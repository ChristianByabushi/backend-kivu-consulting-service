...
def index(request):
    ...
    if request.user.is_superuser:
        ...
        return redirect("montrer_vehicules_a_louer") 
     
def voir_panier(request):
    return ''

def retirer_dans_panier(request):
    return ''

def ajouter_dans_panier(request):
    return ''
...
def vehicule_editer(request, numeroplaque):
    ...
    return render(
        request,
        "garage/forms/editerVehicule.html",
        {"vehicule": vehicule, "marques": marques},
    )
...
def vehicule_ajouter(request):
    ...
    marques = Marque.objects.all()
    return render(
        request, "garage/forms/ajouterVehicule.html", {"form": form, "marques": marques}
    )
